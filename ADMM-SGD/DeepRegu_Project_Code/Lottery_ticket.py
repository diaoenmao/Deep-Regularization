...
def main(args, ITE=0):
    ...
    if args.dataset == "mnist":
        ...
        from archs.mnist import AlexNet, LeNet5, cnn3, vgg, resnet

    elif args.dataset == "cifar10":
        traindataset = datasets.CIFAR10('../data', train=True, download=True,transform=transform)
        testdataset = datasets.CIFAR10('../data', train=False, transform=transform)      
        from archs.cifar10 import AlexNet, LeNet5, cnn3, vgg, resnet, densenet
        ...
        from archs.cifar100 import AlexNet, cnn3, LeNet5, vgg, resnet
    ...
    global model
    if args.arch_type == "cnn3":
       model = cnn3.cnn3().to(device)
...
if __name__=="__main__":
    ...
    parser.add_argument("--arch_type", default="cnn3", type=str, help="cnn3 | lenet5 | alexnet | vgg16 | resnet18 | densenet121")
