"""Run XOR at m=512 with dropout sweep to show dropout effect."""
import sys, os, json
import numpy as np
import torch
...
if __name__ == "__main__":
    ...
    for dr in dropout_rates:
        print(f"Running XOR m=512 dropout={dr}...")
        bk, bk_std = run_single("xor", 2, 512, dr)
        results[str(dr)] = {"m": 512, "best_k": bk, "best_k_std": bk_std}
        print(f"  best-k={bk:.1%} +/- {bk_std:.1%}")

    out_path = os.path.join(ROOT, "results", "ablations", "dropout_xor_m512.json")
