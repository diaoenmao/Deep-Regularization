...
def run_fs_method(
    ...
    elif method_name in ('admm_global', 'admm_layer', 'admm_neuron',
                          'admm_input_group', 'lasso_input_group',
                          'lasso_global', 'lasso_layer', 'lasso_neuron'):
        y_train_hat, y_hat, scores, scores2 = run_admm_lasso_fs(
            method_name, X_train, y_train, X_test, n_classes)
    else:
