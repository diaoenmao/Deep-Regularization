...
At $m{=}128$, where the signal-to-noise ratio is 1.6\% for XOR, our method achieves perfect 100\% best-$k$ accuracy, matching RF, TreeSHAP, and LassoNet.
...
Tables~\ref{tab:xor-dim}--\ref{tab:rxs-dim} show best-$k$ accuracy for each synthetic task as $m$ increases.
