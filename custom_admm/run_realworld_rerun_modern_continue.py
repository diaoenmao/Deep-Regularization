#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Continue the real-world rerun from the modern-dataset stages only."""
...
STATUS_PATH = ROOT / "custom_admm" / "results" / "realworld_rerun_modern_status.json"
MODERN_DATASETS = ["fashion", "coil20", "isolet", "mice", "har"]
MODERN_ADMM_REMAINING = ["isolet", "mice", "har"]
